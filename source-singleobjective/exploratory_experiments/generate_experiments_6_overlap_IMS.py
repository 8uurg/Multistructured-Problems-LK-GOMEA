# NOTE: THIS EXPERIMENT HAS NOT BEEN USED.
...
population_sizes = ("IMS",) # ("IMS", 16, 32, 64, 128, 256, 512, 1024, 2048)
...
t_f_mfs = (
    ...
    (       "7_-1", "3",  "3", "1"), # kNN mating restriction (\w k=sqrt(|P|), linkage tree, FOS per node
