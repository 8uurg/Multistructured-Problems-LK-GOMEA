...
exp_name = "paper_multiobjective_dynamick_" + get_git_revision_short_hash() 
...
run_maxcut_vs_maxcut  = False # Disable: Faster!
run_bot_vs_onemax     = False # Disable: No Onemax (keep down number of problems)
run_bot_vs_maxcut     = False # Disable: Faster!
run_bot_vs_bot        = True
