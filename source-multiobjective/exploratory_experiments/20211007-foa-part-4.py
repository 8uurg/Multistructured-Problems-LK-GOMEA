...
approaches = [
    ...
    # Part 4 - No extreme kernels.
    "-21_0 -c8 -x9_-3 -F11", # 'Favorite' configuration - S(ubset)D(ensity)UHV
    "-19_0 -c8 -x9_-3 -F11", # S(ubset)UHV (i.e. no density correction)
    "-22_0 -c8 -x9_-3 -F11", # D(ensity)UHV (i.e. no usage of subsets)
]
