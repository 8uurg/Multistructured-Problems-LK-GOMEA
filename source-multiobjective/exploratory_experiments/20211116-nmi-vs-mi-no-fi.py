...
approaches = [
    "-3_-1 -c0 -F-1", # Scalarized MO-GOMEA
    "-3_-1 -c8 -x-1 -F-1", # + KNN
    "-3_-1 -c9 -x-1 -F-1", # + Symmetric KNN
    "-3_-1 -c0 -N -F-1", # Scalarized MO-GOMEA + NMI (instead of MI)
    "-3_-1 -c8 -x-1 -N -F-1", # + KNN + NMI (instead of MI)
    "-3_-1 -c9 -x-1 -N -F-1", # + Symmetric KNN + NMI (instead of MI)
]
