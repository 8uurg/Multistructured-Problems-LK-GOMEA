...
approaches = [
    ...
    "-3_-1 -c8 -x-2", # + KNN
    "-3_-1 -c9 -x-2", # + Symmetric KNN
    # "-3_-1 -c0 -N", # Scalarized MO-GOMEA + NMI (instead of MI)
    "-3_-1 -c8 -x-2 -N", # + KNN + NMI (instead of MI)
    "-3_-1 -c9 -x-2 -N", # + Symmetric KNN + NMI (instead of MI)
]
