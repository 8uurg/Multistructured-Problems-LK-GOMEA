...
exp_name = "investigate-pruned-linkage-tree"

approaches = [
    # "-3_-1 -c0", # Scalarized MO-GOMEA
    "-3_-1 -c8_-1 -x-1", # + KNN
    "-3_-1 -c9_-1 -x-1", # + Symmetric KNN
    # "-3_-1 -c0 -N3", # Scalarized MO-GOMEA
    "-3_-1 -c8_-1 -x-1 -N3", # + KNN
    "-3_-1 -c9_-1 -x-1 -N3", # + Symmetric KNN
]
